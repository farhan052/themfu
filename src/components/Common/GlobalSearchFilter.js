...
const JobListGlobalFilter = ({ setGlobalFilter }) => {
    ...
    return (
        <React.Fragment>
            <Col xxl={2} lg={3}>
                <select className="form-control select2  mb-xxl-0" defaultValue="Status" onChange={(e) => handleSelectStatus(e.target)}>
            ...
            <Col xxl={2} lg={3}>
                <select className="form-control select2 mb-xxl-0" defaultValue="Select Type" onChange={(e) => handleSelectTime(e.target)}>
